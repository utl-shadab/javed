          ...
          {SERVICES.map((service, i) => {
            ...
            return (
              <motion.div
                ...
                className={`w-full h-auto bg-tila-secondary
                            border border-neutral-200 rounded-2xl p-6 
                            shadow-sm transition-all duration-300 
                            hover:border-black/20 flex flex-col justify-between cursor-pointer`}
              >
                <div className="mb-4 flex-shrink-0">
                  <Icon width={32} height={32} className="text-[#0A1A63]" />
                </div>

                <div className="flex-1 overflow-hidden">
                  <h3 className="text-[#0A1A63] font-semibold text-lg sm:text-xl mb-2 leading-tight">
                    {service.title}
                  </h3>
                  <p className="text-[#0A1A63] text-sm sm:text-base leading-relaxed line-clamp-3 opacity-90 mb-4">
                    {service.excerpt}
                  </p>
                </div>
                ...
                <Link
                  ...
                  className="text-[#0A1A63] text-sm font-medium inline-flex items-center gap-1 self-start"
                >
