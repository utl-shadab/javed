      ...
      <div className="text-center z-10 w-full max-w-4xl mx-auto py-8 sm:py-12">
        ...
        <motion.h1
          ...
          className="font-extrabold text-[#1a1a1a] leading-[1.1]
                     text-[2.5rem] sm:text-[2rem] md:text-[3rem] lg:text-[4rem]"
        >
        ...
        <motion.p
          ...
          className="mt-6 sm:mt-8 max-w-2xl mx-auto text-center text-[#666] text-base sm:text-xl leading-relaxed px-2"
        >
        ...
        >
          ...
          <div className="grid grid-cols-1 gap-4 md:hidden">
            <div className="flex items-center gap-3 bg-gradient-to-r from-blue-50 to-white p-4 rounded-xl border border-blue-100 shadow-sm">
              <div className="w-10 h-10 bg-tila-primary rounded-full flex items-center justify-center">
        ...
        <motion.button
          ...
          className="mt-14 sm:mt-8 px-6  w-full sm:w-fit sm:px-8 md:py-3 py-4 bg-tila-primary text-white rounded-full text-sm sm:text-base font-medium hover:bg-tila-primary/90 transition shadow-lg"
        >
          Get in Touch
        </motion.button>
        </Link>
